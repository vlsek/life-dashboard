const translations = {
    en: {
        ...
        tour_2_text: "Every day you tick off your daily metrics (yes/no, numbers, sets) and can add items to \"Planned for today\". The circle shows how much of the day is done (the History section shows every day and week as a calendar), the flame is your streak, and points are what you earn for completed things.\n\nThe ⚙️ icons next to blocks let you customize what is shown.",
        tour_3_title: "Goals",
        ...
        hist_title: "History",
        hist_h1: "🕘 History",
        hist_intro: "Progress by day and week. The fuller a day is filled, the more you got done; fully green means 100%. Tap a day to see the details.",
        ...
        // english page
        eng_intro: "A dictionary of new words in any language you learn — add what you come across, mark it once learned.",
        eng_field_lang: "Language",
        eng_field_translate_to: "Translate to",
        eng_filter_all: "All",
        eng_lang_migration_hint: "run migration 024 in Supabase (SQL editor)",
        ...
        dash_schedule_at_most: "No more than N times a week",
        dash_schedule_at_most_label: "Times per week, at most (Mon-Sun)",
        dash_schedule_at_most_short: "≤",
        ...
        dash_streak_import_field: "Already had a streak of this many days",
        dash_streak_import_hint_new: "Counted as continuing from today; it stops applying the first day you miss.",
        dash_streak_import_hint_set: "Counted as continuing since",
        dash_streak_import_migration_hint: "run migration 026 in Supabase (SQL editor)",
        ...
        dash_planned_carry_over_btn: "↺ Unfinished from previous days",
        dash_planned_carry_over_title: "Unfinished — add to today?",
        dash_planned_carry_over_add_btn: "Add to today",
        dash_planned_carry_over_empty: "Nothing unfinished in the last 7 days.",
        ...
        workouts_record_label: "Best set:",
        workouts_record_pace_label: "Best pace:",
        workouts_field_tracks_duration: "Also log duration (for average speed/pace)",
        workouts_field_tracks_duration_hint: "Adds a minutes field to each set and shows the value per hour, e.g. km/h for running.",
        workouts_duration_in: "in",
        workouts_duration_placeholder: "min",
        workouts_duration_unit: "min",
        workouts_per_hour: "h",
        workouts_duration_migration_hint: "run migration 027 in Supabase (SQL editor)",
        workouts_field_bilateral: "Track left/right separately",
        workouts_field_bilateral_hint: "Adds a Left/Right toggle to each set (new sets alternate sides by default) and splits records by side.",
        workouts_side_L: "L",
        workouts_side_R: "R",
        workouts_bilateral_migration_hint: "run migration 028 in Supabase (SQL editor)",
    ...
    ru: {
        ...
        tour_2_text: "Каждый день отмечаешь ежедневные метрики (да/нет, числа, подходы) и можешь добавлять пункты в «Запланировано на сегодня». Кружок показывает, насколько выполнен день (раздел «История» показывает каждый день и неделю календарём), огонёк — твой стрик, а баллы копятся за выполненное.\n\nИконки ⚙️ рядом с блоками позволяют настроить, что показывать.",
        tour_3_title: "Цели",
        ...
        hist_title: "История",
        hist_h1: "🕘 История",
        hist_intro: "Прогресс по дням и неделям. Чем полнее закрашен день, тем больше выполнено; полностью зелёный — 100%. Нажми на день, чтобы увидеть подробности.",
        ...
        // english page
        eng_intro: "Словарь новых слов на любом изучаемом языке — добавляй, что встретил, отмечай, когда выучил.",
        eng_field_lang: "Язык",
        eng_field_translate_to: "Переводить на",
        eng_filter_all: "Все",
        eng_lang_migration_hint: "примени миграцию 024 в Supabase (SQL editor)",
        ...
        dash_schedule_at_most: "Не чаще N раз в неделю",
        dash_schedule_at_most_label: "Раз в неделю, не более (пн-вс)",
        dash_schedule_at_most_short: "≤",
        ...
        dash_streak_import_field: "Уже был стрик, дней",
        dash_streak_import_hint_new: "Считается продолжающимся с сегодняшнего дня; перестаёт применяться в первый пропущенный день.",
        dash_streak_import_hint_set: "Считается продолжающимся с",
        dash_streak_import_migration_hint: "примени миграцию 026 в Supabase (SQL editor)",
        ...
        dash_planned_carry_over_btn: "↺ Незавершённое с прошлых дней",
        dash_planned_carry_over_title: "Незавершённое — добавить в сегодня?",
        dash_planned_carry_over_add_btn: "Добавить в сегодня",
        dash_planned_carry_over_empty: "За последние 7 дней ничего незавершённого нет.",
        ...
        workouts_record_label: "Лучший подход:",
        workouts_record_pace_label: "Лучший темп:",
        workouts_field_tracks_duration: "Также фиксировать длительность (для средней скорости)",
        workouts_field_tracks_duration_hint: "Добавляет поле минут к каждому подходу и показывает значение в час, например км/ч для бега.",
        workouts_duration_in: "за",
        workouts_duration_placeholder: "мин",
        workouts_duration_unit: "мин",
        workouts_per_hour: "ч",
        workouts_duration_migration_hint: "примени миграцию 027 в Supabase (SQL editor)",
        workouts_field_bilateral: "Разделять левую и правую сторону",
        workouts_field_bilateral_hint: "Добавляет переключатель Л/П к каждому подходу (новые подходы по умолчанию чередуют сторону) и делит рекорды по сторонам.",
        workouts_side_L: "Л",
        workouts_side_R: "П",
        workouts_bilateral_migration_hint: "примени миграцию 028 в Supabase (SQL editor)",
