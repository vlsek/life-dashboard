...
Личный трекер целей, метрик и привычек с публичной визиткой на главной странице.
...
| Файл | Что это |
|---|---|
| `index.html` | Публичная визитка (без логина) |
...
### 5. Визитка
В `index.html` / `portfolio.css` заменить контент hero-блока, ссылки, блок "Обо мне", проекты — всё помечено комментариями `<!-- ЗАМЕНИ: ... -->`.
